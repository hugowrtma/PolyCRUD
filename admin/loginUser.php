...
<div class="h-[80vh] flex items-center">
    <div class="login w-1/4 mx-auto">
        <h1 class="text-xl font-bold mb-5">Masuk Admin</h1>
...
?>
                ...
                <button type="submit" class="bg-emerald-600 hover:bg-emerald-700 text-white w-full rounded-lg py-2">Masuk</button>

                <div class="flex justify-center">
                    <p class="text-sm">belum punya akun? <a href="index.php?page=registerUser"><span class="text-red-600 font-semibold">Daftar</span></a></p>
                </div>
                <div class="flex justify-center">
                    <p class="text-sm">Saya Dokter <a href="index.php?page=loginDokter"><span class="text-indigo-600 font-semibold">Masuk Dokter</span></a></p>
                </div>
            </div>
        </form>
